...
class OneModel
@Inject
constructor(repositoryManager: IRepositoryManager) : BaseModel(repositoryManager), OneContract.Model {
    override fun getHotMovie(evictCache: Boolean): Observable<HotMovieBean> {
