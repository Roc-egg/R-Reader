 ...
 * 修改备注：
 */
abstract class BaseHeadeActivity<P : IPresenter> : AppCompatActivity(), IActivity, ActivityLifecycleable {
    ...
    // 头部布局view
    protected var HeaderView: View
    // 标题布局view
    protected var TitleView: View
    // 加载中
    ...
    override fun setContentView(@LayoutRes layoutResID: Int) {
        mView = layoutInflater.inflate(R.layout.activity_header_base, null, false)
        // 内容
        ContentView = layoutInflater.inflate(layoutResID, null, false)
        // 头部
        HeaderView = layoutInflater.inflate(setHeaderLayout(), null, false)
        // 标题
        TitleView = layoutInflater.inflate(R.layout.base_header_title_bar, null, false)
        ...
        val mTitleContainer = mView.findViewById<RelativeLayout>(R.id.title_container)
        ...
        val mHeaderContainer = mView.findViewById<RelativeLayout>(R.id.header_container)
